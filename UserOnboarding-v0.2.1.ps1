...
if ((Get-Location).Path -ne "C:\Ozdoc\UserOnboarding") {
    ...
    ## Get the latest version of the script after updating
...
$magnifyButton.Location = New-Object System.Drawing.Point(298, 97)
...
$newSAMAccountName.Size = New-Object System.Drawing.Size(270,23)
