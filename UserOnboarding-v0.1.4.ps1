...
if ($updateAvailable = $true) {
    Invoke-WebRequest 'https://github.com/eblackadder99/OzdocOnboarding/archive/refs/tags/Release.zip' -OutFile C:\Ozdoc\UserOnboarding.zip
    Expand-Archive C:\Ozdoc\UserOnboarding.zip C:\Ozdoc\ -ErrorAction SilentlyContinue
    Rename-Item C:\Ozdoc\OzdocOnboarding-Release C:\Ozdoc\UserOnboarding -Force
    Remove-Item C:\Ozdoc\UserOnboarding.zip -Force
    Move-Item -Path $tempLocation -Destination $fileToKeep -Force
}
