...
$msgBoxInput = [System.Windows.Forms.MessageBox]::Show("have you installed the required PS modules? (Microsoft.Graph | ExchangeOnline | DuoSecurity)", 'Verify Modules','YesNoCancel','Error')
...
{
    & C:\Ozdoc\Update\UpdateOnboardingScript.ps1
