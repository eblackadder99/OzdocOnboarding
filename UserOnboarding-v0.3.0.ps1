...
$onboardingUserForm.Text = 'New User Onboarding'
...
$Username.Size = New-Object System.Drawing.Size(270,23)
...
## Creates the button for the magnifying glass
$magnifyButton = New-Object System.Windows.Forms.Button
$magnifyButton.Location = New-Object System.Drawing.Point(298, 47)
$magnifyButton.Size = New-Object System.Drawing.Size(26, 26)

$magnifyButtonLabel = New-Object System.Windows.Forms.Label
$magnifyButtonLabel.Text = [char]::ConvertFromUtf32(0x0001F50D)
$magnifyButtonLabel.AutoSize = $true
$magnifyButton.Controls.Add($magnifyButtonLabel)

## Adds a click event to the magnify button
$magnifyButton.Add_Click({
    # Create the userSearch form
    $userSearchForm = New-Object System.Windows.Forms.Form
    $userSearchForm.Text = "User Search"
    $userSearchForm.Size = New-Object System.Drawing.Size(350,400)
    
    # Add the Ozdoc logo
    $userSearchFormOzdocLogo = New-Object System.Windows.Forms.PictureBox
    $userSearchFormOzdocLogo.SizeMode = [System.Windows.Forms.PictureBoxSizeMode]::Zoom
    $userSearchFormOzdocLogo.Location = New-Object System.Drawing.Point (215,0)
    $userSearchFormOzdocLogo.Width = 125
    $userSearchFormOzdocLogo.Height = 30
    $userSearchFormOzdocLogo.Image = $OzdocLogoImage
    $userSearchForm.Controls.Add($userSearchFormOzdocLogo)
    $userSearchFormOzdocLogo.Add_Click({
        Start-Process "https://github.com/eblackadder99/OzdocOnboarding"
    })

    ## Adds the label
    $userSearchFormLabel = New-Object System.Windows.Forms.Label
    $userSearchFormLabel.Text = "Enter username to search"
    $userSearchFormLabel.Location = New-Object System.Drawing.Point(15,10)
    $userSearchFormLabel.AutoSize = $true

    ## Adds the text box
    $userSearchFormTextBox = New-Object System.Windows.Forms.TextBox
    $userSearchFormTextBox.Location = New-Object System.Drawing.Point(15,35)
    $userSearchFormTextBox.Width = 225

    ## Adds the search button
    $userSearchFormSearchButton = New-Object System.Windows.Forms.Button
    $userSearchFormSearchButton.Text = "Search"
    $userSearchFormSearchButton.Location = New-Object System.Drawing.Point(245,33)
    $userSearchFormSearchButton.Add_MouseEnter({
    $userSearchFormSearchButton.BackColor = [System.Drawing.Color]::LightBlue
    })
    $userSearchFormSearchButton.Add_MouseLeave({
    $userSearchFormSearchButton.BackColor = [System.Drawing.Color]::Transparent
    })

    ## Adds the list box
    $userSearchFormListBox = New-Object System.Windows.Forms.ListBox
    $userSearchFormListBox.Size = New-Object System.Drawing.Size(305,240)
    $userSearchFormListBox.Location = New-Object System.Drawing.Point(15,70)

    ## Searches for the user and adds all output to an array
    $userSearchFormSearchButton.Add_Click({
    $usernameSearch = $userSearchFormTextBox.Text
    $usernameSearch = "*" + $usernameSearch + "*"
    
    $userSearchInput = Get-ADUser -Filter {Name -like $usernameSearch}
    
    $userSearchFormListBox.Items.Clear()
    
    if ($userSearchInput) {
        $userSearchFormListBox.Items.Add($userSearchInput.Name)
        $userSearchFormListBox.SelectedIndex = 0
    }
    
    $userSearchFormTextBox.Focus()
    })

    ## Adds the enter button
    $userSearchFormEnterButton = New-Object System.Windows.Forms.Button
    $userSearchFormEnterButton.Text = "Enter"
    $userSearchFormEnterButton.Location = New-Object System.Drawing.Point(70, 320)
    $userSearchFormEnterButton.Add_MouseEnter({
    $userSearchFormEnterButton.BackColor = [System.Drawing.Color]::LightBlue
    })
    $userSearchFormEnterButton.Add_MouseLeave({
        $userSearchFormEnterButton.BackColor = [System.Drawing.Color]::Transparent
    })

    $userSearchFormEnterButton.Add_Click({
        $usernameSearch = $userSearchFormListBox.SelectedItem
        $usernameSearch = "*" + $usernameSearch + "*"
    
        $userSearchInput = Get-ADUser -Filter {Name -like $usernameSearch}
    
        if ($userSearchInput) {
            $username.Text = $userSearchInput.SAMAccountName
            $userSearchForm.Close()
            }
    })

    ## Adds the cancel button
    $userSearchFormCancelButton = New-Object System.Windows.Forms.Button
    $userSearchFormCancelButton.Text = "Cancel"
    $userSearchFormCancelButton.Location = New-Object System.Drawing.Point(190,320)
    $userSearchFormcancelButton.DialogResult = [System.Windows.Forms.DialogResult]::Cancel
    $userSearchFormcancelButton.Add_MouseEnter({
        $userSearchFormcancelButton.BackColor = [System.Drawing.Color]::LightBlue
        })
    $userSearchFormcancelButton.Add_MouseLeave({
        $userSearchFormcancelButton.BackColor = [System.Drawing.Color]::Transparent
    })

    ## Adds the controls to the userSearch form
    $userSearchForm.Controls.Add($userSearchFormLabel)
    $userSearchForm.Controls.Add($userSearchFormTextBox)
    $userSearchForm.Controls.Add($userSearchFormSearchButton)
    $userSearchForm.Controls.Add($userSearchFormListBox)
    $userSearchForm.Controls.Add($userSearchFormEnterButton)
    $userSearchForm.Controls.Add($userSearchFormCancelButton)

    ## Shows the userSearch form
    $userSearchForm.ShowDialog()
})

# Add the PictureBox to the onboarding user form
$onboardingUserForm.Controls.Add($magnifyButton)
...
if ($result = $true)
{
    $userExists = Get-ADUser -Filter { SamAccountName -eq $Username.Text }
